...
#Ensemble de faits
dest_kb.tell(expr('Compagnie(Seul)'))
dest_kb.tell(expr('Interet(Aventure)'))
dest_kb.tell(expr('Budget(Elevé)'))
dest_kb.tell(expr('Climat(Océanique)'))
...
#Regles pour définir que le budget Moyen est inclu dans l'Elevé
